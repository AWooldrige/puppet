 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         '<%= wp_unique_auth_key %>');
define('SECURE_AUTH_KEY',  '<%= wp_unique_secure_auth_key %>');
define('LOGGED_IN_KEY',    '<%= wp_unique_logged_in_key %>');
define('NONCE_KEY',        '<%= wp_unique_nonce_key %>');
define('AUTH_SALT',        '<%= wp_unique_auth_salt %>');
define('SECURE_AUTH_SALT', '<%= wp_unique_secure_auth_salt %>');
